        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center">
              <img
                src="./src/assets/MetavetImages/1400174347.4b8b77bd209eacb0ecab.jpg" // Replace with the actual image
                alt="Frontline Plus for Cats"
            ...
            <p className="text-gray-600">Brand: Frontline Plus</p>

            <h3 className="text-xl font-semibold text-gray-800">Description</h3>
            <p className="text-gray-600">
              Unleash the mighty flea and tick killing force! From the #1 name
              in flea and tick protection, FRONTLINE® Plus for Cats offers
              fast-acting, long-lasting, waterproof flea and tick control.
              FRONTLINE Plus for Cats contains two tough killing ingredients -
              one to kill adult fleas and ticks and one to kill flea eggs and
              larvae to prevent new flea infestations from starting. It kills
              ticks that may transmit diseases like Lyme disease and other
              tick-borne diseases. One easy topical application works for a full
              month.
            </p>
            ...
            <ul className="list-disc pl-6 text-gray-600">
              <li>
                One (1) Pack FRONTLINE Plus for Cats (1.5 pounds and over),
                3-Dose Flea and Tick Treatment
              </li>
              <li>
                Kills fleas, ticks, and chewing lice on contact—no biting
                required
              </li>
              <li>
                Breaks the flea life cycle by killing flea eggs and larvae
              </li>
              <li>
                3-Month supply for one cat (8 weeks and older, 1.5 pounds and
                up)
              </li>
              <li>
                Easy to apply: apply between your cat's shoulders once a month
              </li>
              <li>Fast-acting & long-lasting protection for a full 30 days</li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="mt-4">
              <p className="text-xl font-semibold text-gray-700">$34.99</p>
