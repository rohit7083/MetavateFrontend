  ...
  return (
    <div className="pt-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center">
              <img
                src="./src/assets/MetavetImages/1400179616.0152d7157beff2ab3153.jpg" // Replace with the actual image path
            ...
            <h1 className="text-3xl font-bold text-gray-800">
              Small Pet Glass Water Bottle
            </h1>
            <p className="text-gray-600">Brand: All Living Things®</p>

            <h3 className="text-xl font-semibold text-gray-800">Description</h3>
            <p className="text-gray-600">
              Keep your pet hydrated with this small pet glass water bottle.
              Ideal for small animals, it’s easy to install and ensures a
              constant water supply for your pet. Perfect for your pet’s cage,
              it provides fresh water all day long.
            </p>

            <h3 className="text-xl font-semibold text-gray-800">Directions</h3>
            <ul className="list-disc pl-6 text-gray-600">
              <li>Open top to fill the bottle.</li>
              <li>
                Invert the bottle and fix it on the cage with a U-shape iron
                wire hook.
              </li>
              <li>
                Fix the spring buckle to the iron wire of the cage along the
            ...
            <ul className="list-disc pl-6 text-gray-600">
              <li>To Clean Nozzle:</li>
              <li>1. Fill a bowl full of clean water.</li>
              <li>2. Remove cap with nozzle tube attached from the bottle.</li>
              <li>3. Squirt a pet-safe detergent into the nozzle tube.</li>
              <li>
                4. With finger stopping the top of the nozzle tube, place the
                cap and nozzle into the bowl of water.
              </li>
              <li>
                5. Swish soapy water inside nozzle using a seesaw action until
                all soap is rinsed clean.
              </li>
              <li>
                6. Keep the ball free of dirty particles such as hair, fur, and
                grease to ensure nozzle functionality.
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="mt-4">
              <p className="text-xl font-semibold text-gray-700">$11.99</p>
              <p className="text-gray-600">12 oz</p>
            ...
            <div className="mt-4">
              ...
              {/* Add share buttons or links here */}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center items-center space-x-12 mb-8 pt-10">
        {/* Back to catalog, search, or shopping icons */}
