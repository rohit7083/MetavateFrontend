        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center">
              <img
                src="./src/assets/MetavetImages/1604571435.5ec044a48f5ce466ce00.jpg" // Replace with the actual image
                alt="Cosequin for Dogs"
            ...
            <h1 className="text-3xl font-bold text-gray-800">
              Cosequin® Sprinkle Caps
            </h1>
            <p className="text-gray-600">Brand: Cosequin®</p>

            <h3 className="text-xl font-semibold text-gray-800">Description</h3>
            <p className="text-gray-600">
              Cosequin® Sprinkle Caps is a supplement that contains glucosamine
              and chondroitin, which are natural compounds found in healthy
              cartilage, plus manganese, which helps in the formation of
              cartilage, to support the overall health and mobility of joints.
              It helps protect existing cartilage from breakdown, support
              cartilage production, and maintain joint fluid for optimal joint
              and connective tissue health.
            </p>

            <h3 className="text-xl font-semibold text-gray-800">Benefits</h3>
            <ul className="list-disc pl-6 text-gray-600">
              <li>Helps protect existing cartilage from breakdown</li>
              <li>Supports cartilage production</li>
              <li>Maintains joint fluid for optimal joint health</li>
              <li>Ideal for smaller dogs with regular strength needs</li>
              <li>Capsule form for accurate dosage</li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="mt-4">
              <p className="text-xl font-semibold text-gray-700">$25.98</p>
              <p className="text-gray-600">80 ct box</p>
