        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center">
              <img
                src="./src/assets/MetavetImages/1400179006.7f65fa27d48e4bcad9cb.jpg" // Replace with the actual image
            ...
            <p className="text-gray-600">Brand: Oxbow Essentials</p>

            <h3 className="text-xl font-semibold text-gray-800">Description</h3>
            <p className="text-gray-600">
              Oxbow Essentials Adult Rabbit Bunny Basics pellets provide rabbits
              with the fiber their digestive systems need. You want your rabbit
              to have a balanced diet full of proper nutrition, and these
              pellets provide that balance and more.
            </p>

            <h3 className="text-xl font-semibold text-gray-800">Features</h3>
            <ul className="list-disc pl-6 text-gray-600">
              <li>
                All rabbits need high fiber to keep their digestive systems
                working properly, plus basic vitamins and minerals to maximize
                their health.
              </li>
              <li>
                Essentials - Adult Rabbit Food combines needed fiber with
                stabilized nutrients to assure a well-balanced diet when served
                with Oxbow loose grass hays.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 text-gray-600">
              <li>Food Type: Pellets</li>
              <li>Life Stage: Adult</li>
              <li>Primary Ingredient: Timothy Grass Meal</li>
              <li>Package Weight: 5 lb</li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="mt-4">
              <p className="text-xl font-semibold text-gray-700">$10.99</p>
