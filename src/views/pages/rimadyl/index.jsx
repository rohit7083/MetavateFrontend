        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center">
              <img
                src="./src/assets/MetavetImages/1599590763.ba669f016b74ca5d3f37.jpg" // Replace with the actual image URL
                alt="Rimadyl Chewables for Dogs"
            ...
            <h1 className="text-3xl font-bold text-gray-800">
              Rimadyl® Chewables for Dogs
            </h1>
            <p className="text-gray-600">Brand: Rimadyl®</p>
            <p className="text-gray-600 font-semibold">
              Prescription Required: Yes (Our pharmacy provider may need to
              contact your veterinary hospital for prescription verification.)
            </p>

            <h3 className="text-xl font-semibold text-gray-800">Description</h3>
            <p className="text-gray-600">
              Rimadyl® is used in dogs for the relief of pain and inflammation
              associated with osteoarthritis, as well as the control of
              post-operative pain associated with soft tissue and orthopedic
              surgeries. It works by reducing hormones that cause pain and
              inflammation in your dog's body.
            </p>
            ...
            <ul className="list-disc pl-6 text-gray-600">
              ...
              <li>
                Helps with pain and inflammation associated with osteoarthritis
              </li>
              <li>
                Relieves post-operative pain after soft tissue and orthopedic
                surgeries
              </li>
              <li>Chewables are flavored for easy consumption by most dogs</li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="mt-4">
              <p className="text-xl font-semibold text-gray-700">$65.98</p>
              <p className="text-gray-600">100 mg | 30-ct Bottle</p>
