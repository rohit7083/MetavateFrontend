        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center">
              <img
                src="./src/assets/MetavetImages/1400154938.0483de78d5d72b0fcbfe.jpg" // Replace with the actual image
                alt="Milk Bone Mini's Flavor Snacks Dog Biscuits"
            ...
            <h1 className="text-3xl font-bold text-gray-800">
              Milk Bone Mini's Flavor Snacks Dog Biscuits
            </h1>
            <p className="text-gray-600">Brand: Milk-Bone</p>

            <h3 className="text-xl font-semibold text-gray-800">Description</h3>
            <p className="text-gray-600">
              Serve your dog a treat you can feel good about serving them with
              Milk Bone Mini's Flavor Snacks Dog Biscuits. Your dog will enjoy 5
              assorted flavors, and each treat promotes healthy teeth and is
              infused with a number of essential vitamins.
            </p>

            <h3 className="text-xl font-semibold text-gray-800">Features</h3>
            <ul className="list-disc pl-6 text-gray-600">
              <li>
                Milk-Bone Mini's Flavor Snacks dog biscuits feature the same
                teeth-cleaning and vitamin-enriched goodness of Milk-Bone
                Original biscuits in a tasty bite-sized treat.
              </li>
              <li>5 Different Flavors</li>
              <li>Promotes healthy teeth</li>
              <li>Infused with essential vitamins</li>
              <li>36 oz package</li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold text-gray-800">
              Milk-Bone Mini's Flavor Snacks
            </h2>
            ...
            <div className="mt-4">
              ...
              <p className="text-gray-600">36 oz</p>
