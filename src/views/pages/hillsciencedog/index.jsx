        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center">
              <img
                src="./src/assets/MetavetImages/1400154588.eb5ce5dc00c0f9b31b25.jpg" // Replace with the actual image path
            ...
            <p className="text-gray-600">
              Hill's Science Diet Sensitive Stomach & Skin dry dog food provides
              optimal digestive health while nourishing skin & promoting a
              lustrous coat. Help your dog to look and feel his best by serving
              this delicious and nutritious dry food.
            </p>
            ...
            <ul className="list-disc pl-6 text-gray-600">
              <li>
                Prebiotic fiber to fuel beneficial gut bacteria & support a
                balanced microbiome
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <div className="mt-4">
              <p className="text-xl font-semibold text-gray-700">$57.99</p>
              <p className="text-gray-600">30 lbs</p>
