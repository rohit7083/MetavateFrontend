        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center">
              <img
                src="./src/assets/MetavetImages/1400174603.82da2e4239bdbc603a72.jpg" // Replace with the actual image URL
            ...
            <p className="text-gray-600">Brand: Whisker City®</p>

            <h3 className="text-xl font-semibold text-gray-800">Description</h3>
            <p className="text-gray-600">
              This playful and colorful Feathers Teaser Cat Toy is the perfect
              way to engage your furry friend. Featuring interactive feathers
              that will keep your cat entertained for hours, it’s a must-have
              toy for feline fun!
            </p>
            ...
            <ul className="list-disc pl-6 text-gray-600">
              <li>Size: 9.5 in</li>
              <li>
                Caution: Contains small parts. Adult supervision is recommended
                for children under 12 years of age.
              </li>
              <li>
                Advice for Use: Observe your pet's behavior with the toy for
                suitability. Some toys may be inappropriate for your pet. Remove
                and replace the toy if it becomes damaged.
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600">Store/Cat Products</p>
            ...
            <div className="mt-4">
              <p className="text-xl font-semibold text-gray-700">$3.99</p>
